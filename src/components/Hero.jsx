            ...
            <div className='container relative'>
                <div className='flex lg:flex-row flex-col gap-5 max-lg:pt-12'>
                    ...
                    <div className='absolute right-[-57px] top-[60px] xl:block hidden'>
                        <img className='max-w-[470px] h-[559px] w-full pointer-events-none' src="./assets/images/png/robot.png" alt="hero-image" />
                    </div>
                    <div className='xl:hidden flex justify-center'>
                        <img className='w-full max-w-[470px] pointer-events-none' src="./assets/images/png/robot.png" alt="hero-image" />
                    </div>
                </div>
            </div>
        </div>
