...
const GlobalCounter = () => {
    ...
    return (
        <div className="bg-off-black text-white lg:pt-14 md:pt-12 pt-10  lg:pb-[175px] md:pb-12 pb-10 relative">
                    ...
                    {COUNTER_DATA.map(({ id, number, prefix = "", unit = "", description }, index) => (
                        ...
                        >
                            <div className="flex items-center justify-center lg:text-5xl text-3xl font-semibold">
                                {prefix && <span className="lg:text-5xl text-3xl">{prefix}</span>}
                                {index < 3 ? (
                            ...
                            <p className="lg:text-base text-sm text-white font-normal mt-2 md:max-w-[187px]">{description}</p>
                        </div>
                    ))}
                </div>
            </div>
